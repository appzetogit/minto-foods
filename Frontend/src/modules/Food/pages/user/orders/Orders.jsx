...
export default function Orders() {
        ...
        if (ordersData.length > 0) {
          ...
          const transformedOrders = ordersData.map(order => {
            ...
            return {
              ...
              platformFee,
              quickDeliveryFee,
              basePlatformFee: Math.max(0, platformFee - quickDeliveryFee),
              tax,
  ...
  const handleShareRestaurant = async (order) => {
    ...
    const shareText = `Check out ${restaurantLabel(order.restaurant)} on ${companyName}.
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 pb-10 font-sans">
                ...
                <div className="flex items-start justify-between p-4 pb-2">
                  <div className="flex gap-3">
                    ...
                    <div className="w-14 h-14 rounded-lg bg-gray-200 overflow-hidden flex-shrink-0">
                      <img
                        src={restaurantImage}
                        alt={restaurantLabel(order.restaurant)}
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-gray-800 dark:text-white text-lg leading-tight">{restaurantLabel(order.restaurant)}</h3>
                ...
                <div className="px-4 py-3 bg-gray-50 dark:bg-slate-950/50 rounded-lg mx-4 mb-2">
                  <div className="space-y-1.5">
                    ...
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="text-gray-800 dark:text-gray-200 font-medium">
                        {order.basePlatformFee > 0 ? `\u20B9${order.basePlatformFee.toFixed(2)}` : "Free"}
                      </span>
                    </div>
                    {order.tax > 0 && (
                      <div className="flex justify-between text-xs">
      ...
      <div className="flex justify-center mt-8 mb-4">
        <h1 className="text-4xl font-black text-gray-200 dark:text-zinc-900 tracking-tighter italic capitalize">Minto Foods</h1>
      </div>
