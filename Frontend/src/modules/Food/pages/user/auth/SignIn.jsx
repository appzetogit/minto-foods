  ...
  return (
    <AnimatedPage className="min-h-[100dvh] bg-white dark:bg-[#0A0A0B] flex flex-col font-sans overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(var(--module-theme-rgb, 0, 128, 120), 0.94) 0%, var(--module-theme-color, #008078) 55%, rgba(var(--module-theme-rgb, 0, 128, 120), 0.82) 100%)",
        }}
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-4">
              <div className="relative group transition-all duration-300">
                <div className="flex items-center gap-0 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl focus-within:border-[#008078]/50 focus-within:ring-4 focus-within:ring-[#008078]/5 transition-all overflow-hidden">
              ...
              {error && (
                <motion.div
                  ...
                  className="flex items-center gap-1.5 text-xs font-bold text-[#008078] pl-2"
                >
            ...
            <Button
              ...
              className="w-full h-16 bg-[#008078] hover:bg-[#D40261] text-white font-black text-base uppercase tracking-widest rounded-2xl transition-all duration-300 shadow-[0_12px_24px_rgba(0, 128, 120,0.3)] hover:shadow-[0_16px_32px_rgba(0, 128, 120,0.4)] active:scale-[0.98] disabled:opacity-50 disabled:grayscale"
            >
              {isLoading ? (
