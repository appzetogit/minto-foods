...
const Cuisines = lazy(() => import("@food/pages/admin/Cuisines"));
...
const CodPayments = lazy(() => import("@food/pages/admin/settings/CodPayments"));
...
const DutyLog = lazy(() => import("@food/pages/admin/delivery-partners/DutyLog"));
      ...
      <Routes>
        ...
        >
          ...
          <Route path="food/*">
            ...
            <Route path="restaurants/billing" element={<RestaurantBilling />} />
            ...
            <Route path="cod-payments" element={<CodPayments />} />
