...
export default function BottomNavigation() {
  ...
  const activeColor = "var(--module-theme-color, #008078)"
  const activeBg = "rgba(var(--module-theme-rgb, 0, 128, 120), 0.12)"
  const activeFill = "rgba(var(--module-theme-rgb, 0, 128, 120), 0.2)"
