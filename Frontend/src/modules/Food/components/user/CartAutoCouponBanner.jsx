  ...
  try {
    const burst = (x) =>
      confetti({
        ...
        ticks: 85,
        origin: { x, y: 0.22 },
        colors: ["#008078", "#ff9ec4", "#22c55e", "#ffffff"],
  ...
  return (
    <AnimatePresence mode="wait">
      {phase === "expanded" ? (
        ...
        >
          <div className="relative overflow-hidden rounded-2xl border border-[#008078]/15 bg-white dark:bg-[#1a1a1a] shadow-[0_6px_24px_rgba(0, 128, 120,0.1)]">
            <div className="absolute inset-0 bg-gradient-to-br from-[#FFF8FB] to-white dark:from-[#008078]/8 dark:to-[#1a1a1a]" />
            <div className="relative px-3.5 py-3 sm:px-4 sm:py-3.5">
              <div className="flex items-center gap-2.5 sm:gap-3">
                <div className="flex h-10 w-10 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-xl bg-[#008078] text-white shadow-[0_6px_16px_rgba(0, 128, 120,0.28)]">
                ...
                <div className="shrink-0 rounded-lg border border-[#008078]/20 bg-[#FFF0F6] dark:bg-[#008078]/10 px-2 py-1.5 sm:px-2.5 text-center">
                  <BadgePercent className="mx-auto h-3.5 w-3.5 text-[#008078]" />
                  <p className="mt-0.5 text-[10px] font-bold text-[#008078]">{appliedCoupon.code}</p>
                </div>
              </div>
              <div className="mt-2.5 h-0.5 overflow-hidden rounded-full bg-[#008078]/10">
                <motion.div
                  className="h-full rounded-full bg-[#008078]"
                  initial={{ width: "100%" }}
                  animate={{ width: "0%" }}
