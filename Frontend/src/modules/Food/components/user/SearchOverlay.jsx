          ...
          <form onSubmit={handleSearchSubmit} className="flex items-center gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-12 pr-12 h-12 w-full bg-white dark:bg-[#1a1a1a] border-gray-100 dark:border-gray-800 focus:border-[#008078] dark:focus:border-[#008078] rounded-full text-lg dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
              />
              <button
                type="button"
                onClick={startVoiceSearch}
                className={`absolute right-4 top-1/2 transform -translate-y-1/2 p-1.5 rounded-full transition-all ${isListening ? 'bg-[#008078] text-white animate-pulse' : 'text-gray-400 hover:text-[#008078] hover:bg-[#008078]/5'}`}
              >
      ...
      {isListening && (
        <div className="absolute inset-0 z-[10000] flex flex-col items-center justify-center bg-white/95 dark:bg-[#0a0a0a]/95 backdrop-blur-md">
          <div className="relative flex items-center justify-center">
            {/* Animated Ripples */}
            <div className="absolute w-40 h-40 bg-[#008078]/20 rounded-full animate-ping" />
            <div className="absolute w-32 h-32 bg-[#008078]/30 rounded-full animate-pulse" />
            
            {/* Mic Icon Container */}
            <div className="relative bg-gradient-to-tr from-[#008078] to-[#ff4b9c] p-8 rounded-full text-white shadow-[0_0_40px_rgba(0, 128, 120,0.4)] border-4 border-white dark:border-gray-800">
            ...
            <div className="absolute -bottom-16 flex items-end gap-1.5 h-12">
              {[1, 2, 3, 4, 5, 6, 7].map((i) => (
                <div 
                  key={i}
                  className="w-1.5 bg-[#008078] rounded-full animate-voice-bar"
                  style={{ 
          ...
          <Button
            variant="ghost"
            onClick={onClose}
            className="mt-16 text-gray-400 hover:text-[#008078] hover:bg-[#008078]/5 rounded-full px-8"
          >
            Cancel
          </Button>
        </div>
