            ...
            <div className="bg-white dark:bg-[#0a0a0a] dark:text-white rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden md:max-w-md md:w-[400px]">
              <div className="flex items-center gap-3 p-3 md:p-4">
                ...
                <Link
                  ...
                  style={{
                    background: "linear-gradient(135deg, rgba(var(--module-theme-rgb,0, 128, 120),0.92), var(--module-theme-color,#008078))",
                    boxShadow: "0 8px 18px rgba(var(--module-theme-rgb,0, 128, 120),0.28)",
                  }}
                >
