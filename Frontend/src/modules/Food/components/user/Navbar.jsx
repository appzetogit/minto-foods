...
export default function Navbar() {
  const { effectiveLocation: location, displayAddressText, loading } = useDeliveryLocation()
        ...
        <div className="flex h-16 sm:h-18 md:h-20 items-center justify-between gap-2 sm:gap-3 md:gap-4">
          ...
          <Link to="/food/user" className="flex items-center justify-center flex-shrink-0">
            {logoUrl ? (
              ...
              <img src={mintoLogo} alt="Logo" className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 object-contain" />
            )}
          </Link>
