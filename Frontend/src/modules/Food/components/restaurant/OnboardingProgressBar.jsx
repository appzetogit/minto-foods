    ...
    <div
      className={`relative flex shrink-0 items-center justify-center rounded-full border-2 font-bold text-white transition-all duration-300 ${
        ...
        isCompleted
          ...
          : isActive
            ? isSidebar
              ? "border-white bg-white text-[#008078] shadow-lg shadow-black/20"
              : "border-[#008078] bg-[#008078] text-white shadow-lg shadow-[#008078]/25 motion-safe:scale-105"
            : isSidebar
  ...
  return (
    <div className="w-full" aria-label={`Step ${currentStep} of ${ONBOARDING_STEPS.length}`}>
      ...
      <div className="mt-3 flex items-center justify-between gap-3">
        ...
        <div className="shrink-0 rounded-full bg-[#008078]/10 px-3 py-1">
