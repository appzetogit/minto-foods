...
export default function UnifiedOTPFastLogin() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col pt-0 sm:pt-0">
      ...
      <div className="w-full bg-[#008078] dark:bg-[#D6005E] rounded-b-[2.5rem] p-6 text-center text-white relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          >
             <span className="text-[#008078] text-3xl font-black">A</span>
          </motion.div>
          <motion.h1 
          ...
          >
            Minto Foods <span className="text-white/80 font-normal">Master</span>
          </motion.h1>
      ...
      <div className="flex-1 max-w-[480px] mx-auto w-full px-6 py-4 flex flex-col justify-center -mt-8 relative z-20">
        ...
        <div className="bg-white dark:bg-[#1a1a1a] rounded-[2rem] p-6 sm:p-8 md:p-12 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.15)] dark:shadow-none border border-gray-50 dark:border-gray-800">
           <div className="text-center mb-6 space-y-2">
              ...
              <div className="h-1 w-12 bg-[#008078] mx-auto rounded-full" />
           </div>
                ...
                <div className="space-y-4">
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-1 flex items-center pointer-events-none">
                      <Phone className="w-5 h-5 text-gray-400 group-focus-within:text-[#008078] transition-colors" />
                    </div>
                    ...
                    <input
                      ...
                      maxLength={10}
                      className="block w-full pl-20 pr-4 py-3 bg-transparent text-gray-900 dark:text-white border-b-2 border-gray-100 dark:border-gray-800 focus:border-[#008078] outline-none transition-all placeholder:text-gray-300 font-bold text-lg"
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                   <div className="flex items-center gap-3 bg-gray-50 dark:bg-gray-900 p-4 rounded-2xl border border-dashed border-gray-200 dark:border-gray-800">
                      <div className="w-10 h-10 bg-[#008078]/10 rounded-full flex items-center justify-center">
                         <ShieldCheck className="w-5 h-5 text-[#008078]" />
                      </div>
                      ...
                      <button type="button" onClick={handleEditNumber} className="text-xs text-[#008078] font-black underline cursor-pointer">Edit</button>
                   </div>
                  ...
                  <div className="flex justify-center gap-3 mt-4">
                    {[0, 1, 2, 3].map((index) => (
                      <input
                        ...
                        className="w-14 h-14 sm:w-16 sm:h-16 text-center text-xl sm:text-3xl font-black bg-gray-50 dark:bg-gray-900 border-2 border-gray-100 dark:border-gray-800 focus:border-[#008078] rounded-xl sm:rounded-2xl outline-none transition-all text-gray-900 dark:text-white"
                        placeholder="-"
                      />
                    ))}
                  </div>
                  <div className="text-center mt-4">
                    {resendTimer > 0 ? (
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="text-xs font-black text-[#008078] underline disabled:opacity-60 disabled:cursor-not-allowed"
                      >
                        Resend OTP
                      </button>
                    )}
            ...
            <button
              ...
              className={`w-full py-4 rounded-2xl font-black text-lg transition-all relative overflow-hidden shadow-xl ${
                loading
                  ...
                  : "bg-[#008078] hover:bg-[#D6005E] text-white hover:shadow-2xl hover:shadow-[#008078]/30 active:scale-[0.98] hover:-translate-y-0.5"
              }`}
            >
              {loading ? (
