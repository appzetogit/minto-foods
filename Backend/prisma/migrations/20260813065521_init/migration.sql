...
-- CreateEnum
CREATE TYPE "FoodTxnStatus" AS ENUM ('pending', 'authorized', 'captured', 'failed', 'refunded');
...
CREATE TABLE "food_restaurants" (
    ...
    "longitude" DOUBLE PRECISION,
    "location" geography(Point, 4326),
    "pendingLatitude" DOUBLE PRECISION,
    "pendingLongitude" DOUBLE PRECISION,
...
CREATE TABLE "food_transactions" (
    ...
    "paymentMethod" "OrderPaymentMethod" NOT NULL,
    "status" "FoodTxnStatus" NOT NULL DEFAULT 'pending',
    "currency" VARCHAR(3) NOT NULL DEFAULT 'INR',
...
-- CreateIndex
CREATE UNIQUE INDEX "food_delivery_bonus_transactions_transactionId_key" ON "food_delivery_bonus_transactions"("transactionId");
...
-- CreateIndex
CREATE UNIQUE INDEX "food_delivery_support_tickets_ticketId_key" ON "food_delivery_support_tickets"("ticketId");
...
-- ============================================================
-- Constraints, triggers and indexes Prisma cannot express
-- (source: prisma/constraints.sql)
-- ============================================================
