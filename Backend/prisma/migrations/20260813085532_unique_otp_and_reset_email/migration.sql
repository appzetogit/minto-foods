-- DropIndex
DROP INDEX "food_admin_reset_otps_email_idx";

-- DropIndex
DROP INDEX "food_otps_phone_idx";
...
-- CreateIndex
CREATE UNIQUE INDEX "food_admin_reset_otps_email_key" ON "food_admin_reset_otps"("email");

-- CreateIndex
CREATE UNIQUE INDEX "food_otps_phone_key" ON "food_otps"("phone");
