...
-- AlterTable
ALTER TABLE "food_items" DROP COLUMN "variants",
...
CREATE TABLE "food_item_variants" (
    ...
    "foodItemId" VARCHAR(24) NOT NULL,
    "name" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "food_item_variants_foodItemId_sortOrder_idx" ON "food_item_variants"("foodItemId", "sortOrder");

-- CreateIndex
CREATE UNIQUE INDEX "food_item_variants_foodItemId_name_key" ON "food_item_variants"("foodItemId", "name");
